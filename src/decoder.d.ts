...
declare class Decoder {
    ...
    static "__#6@#readFileHeader"(stream: any, resetPosition?: boolean): {
        headerSize: any;
        protocolVersion: any;
     ...
     */
    read({ mesgListener, expandSubFields, expandComponents, applyScaleAndOffset, convertTypesToStrings, convertDateTimesToDates, includeUnknownData, mergeHeartRates }?: any | undefined): any;
    #private;
}
